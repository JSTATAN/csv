...
<nav class="navbar navbar-expand-lg navbar-light navbar-dark fixed-top" style="background-color: #000000 !important;">
    ...
    <div class="my-2 my-lg-0">
      <h5 class="navbar-brand">JOHAN SEBASTIAN GONZALEZ
        ADSO:2502629 </h5>
    </div>
</nav>
...
<div class="container mb-5">
  <h3 class="text-center">
      Importar <span style="color:#ffffff;">CSV</span>  usando PHP Fácil
  </h3>
  <hr>
